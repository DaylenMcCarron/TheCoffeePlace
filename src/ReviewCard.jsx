    ...
    return (
        <>
            ...
            <div className=" w-[95%]  rounded-lg mx-auto mt-2 shadow-md bg-white">
                ...
                <hr />
                <div className="text-sm p-2">
                This coffee has a smooth, well-balanced flavor with notes of chocolate and caramel. It's not too strong or bitter, making it a great choice for everyday drinking.
                </div>
