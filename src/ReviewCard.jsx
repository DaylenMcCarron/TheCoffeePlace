    ...
    return (
        <>
            <div className=" w-[95%] rounded-lg mx-auto mt-2 shadow-md bg-white">
                ...
                <img src="./assets/review1.jpeg" alt="" className=" object-cover w-full h-[90vw] rounded-b-lg"/>
            </div>
            <div className=" w-[95%] rounded-lg mx-auto mt-2 shadow-md bg-white">
                <div className=" h-16 w-full flex rounded-t-lg overflow-hidden p-2">
                ...
                <img src="./assets/review2.jpeg" alt="" className=" object-cover w-full h-[90vw] rounded-b-lg"/>
            </div>
            <div className=" w-[95%] rounded-lg mx-auto mt-2 shadow-md bg-white">
                <div className=" h-16 w-full flex rounded-t-lg overflow-hidden p-2">
                ...
                <hr />
                <div className="text-sm p-2">
                The coffee place has seamlessly combined the warmth of a local coffee shop with the convenience of doorstep delivery. A must-try for anyone seeking a daily dose of joy in their coffee mug.
                </div>

                <img src="./assets/review3.jpeg" alt="" className=" object-cover w-full h-[90vw] rounded-b-lg"/>
            </div>
        </>
    )
}
